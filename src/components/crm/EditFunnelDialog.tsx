...
interface EditFunnelDialogProps {
  ...
  onSave: (funnelId: string, newName: string, stageNames: string[]) => void;
}

export function EditFunnelDialog({ funnel, initialStages, isOpen, onOpenChange, onSave }: EditFunnelDialogProps) {
  ...
  const handleSave = () => {
    ...
    onSave(funnel.id, name.trim(), stages);
    onOpenChange(false);
  };
    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Altere o nome do seu funil e gerencie os estágios.
          </DialogDescription>
        </DialogHeader>
